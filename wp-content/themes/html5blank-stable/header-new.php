	...
	<body <?php body_class(); ?>>
		...
		<div class="wrapper">
			...
			<header class="header clear" role="banner">
					...
					<div id="landing-header-links">
						<h4 id="landing-header-links-desk"><a href="mailto:John@SecureHoldingsPortland.com">John@SecureHoldingsPortland.com</a> | <a href="tel:503-539-9094">(503) 539-9094</a></h4>
...
<!-- 					<nav class="nav" role="navigation">
			...
			<div id="landing-tagline">
				<div id="landing-header-mobile">
						<h4 id="landing-header-links-mob"><a href="mailto:John@SecureHoldingsPortland.com">John@SecureHoldingsPortland.com</a><br><a href="tel:503-539-9094">(503) 539-9094</a></h4>
				</div>
			</div>
			<!-- /header -->
